...
import { MKRATE_ICON_DATA_URI } from './mkrateIconDataUri'
...
/** Canonical Mkrate kraken app icon for shared transcript branding. */
function MkrateLogo({ className }: { className?: string }) {
  return <img src={MKRATE_ICON_DATA_URI} alt="Mkrate" className={className} />
}
        ...
        >
          <div className="h-full overflow-y-auto">
            ...
            <div className={CHAT_CLASSES.brandingContainer}>
              <MkrateLogo className="w-8 h-8 opacity-40" />
            </div>
            </div>
          </div>
        </div>

...
# electron-builder outputs: Mkrate-x86_64.AppImage or Mkrate-aarch64.AppImage
BUILT_APPIMAGE_NAME="Mkrate-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Mkrate-x64.AppImage, Mkrate-arm64.AppImage
APPIMAGE_NAME="Mkrate-${ARCH}.AppImage"
